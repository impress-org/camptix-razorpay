...
gulp.task('pot', function () {
	return gulp.src('**/*.php')
		...
		.pipe(wpPot({
			...
			domain: 'camptix-razorpay', //textdomain
			destFile: 'camptix-razorpay.pot',
			bugReport: 'https://github.com/ravinderk/CampTix-Razorpay/issues/new',
			lastTranslator: '',
			team: 'Ravinder Kumar <ravinder.kumar.apj@gmail.com>'
		}))
